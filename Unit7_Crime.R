...
###
SG = get_map(location = "singapore", zoom = 11)
ggmap(SG)
###
...
ggpairs(murderMap, columns=c("GunOwnership","MurderRate","GunMurders"), diag=list(continuous="density",   discrete="bar"), axisLabels="show")
